...
if( !function_exists( 'pixova_lite_enqueue_scripts' ) ) {
    ...
    function pixova_lite_enqueue_scripts() {
        ...
        // Query Loader 2
        wp_register_script( 'query-loader-js', get_template_directory_uri() . '/layout/js/queryloader/queryloader2.min.js', array('jquery'), '3.0.16', true );
        ...
        wp_register_script( 'pie-chart-js', get_template_directory_uri() . '/layout/js/easypiechart/jquery.easypiechart.min.js', array('jquery'), '2.1.7', true );
        ...
        // Preloader JS
        wp_register_script( 'pixova-lite-preloader-js', get_template_directory_uri() . '/layout/js/preloader.min.js', array('query-loader-js'), '1.0', true );
        ...
        if( !isset($wp_customize) ) {
            wp_enqueue_script( 'query-loader-js' );
            wp_enqueue_script( 'pixova-lite-preloader-js' );
        } else {
            function pixova_lite_output_css_to_head() {

                echo '<style>';
                    echo '#container, #footer { visibility: visible !important; }';
                echo '</style>';
            }
