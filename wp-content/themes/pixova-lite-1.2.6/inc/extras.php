...
if( !function_exists( 'pixova_lite_prefix_upsell_notice' ) ) {
    ...
    function pixova_lite_prefix_upsell_notice()
    {
        ...
        wp_localize_script(
            ...
            'prefixL10n',
            array(
                'prefixURL' => esc_url('https://www.pixova-litethemes.com/?edd_action=add_to_cart&download_id=13&discount=DEMO10'),
                'prefixLabel' => __('Upgrade NOW & get 10% off', 'pixova-lite'),
            )
        );
